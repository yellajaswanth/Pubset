...
from gpt2_training.pubmed_train_utils_auto import PubmedDynamicBatchingLoader
...
train_path = 'dataset/db/pubmed_train.db'
...
eval_dataloader_gen = PubmedDynamicBatchingLoader(test_path, args.eval_batch_size, args.max_seq_length, is_train=False)
...
model_bert = BertModel.from_pretrained('biobert-base').cuda()
