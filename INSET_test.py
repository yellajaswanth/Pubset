...
if __name__ == "__main__":
    ...
    tokenizer_bert = BertTokenizer.from_pretrained('biobert-base')

    model_bert = BertModel.from_pretrained('biobert-base', state_dict=torch.load('/home/aniljegga1/Transformers/INSET/auto_log/GPT2.2e-05.64.1gpu.2021-02-08131841/BERT-pretrain-5-step-4500.pkl')).cuda()
    model_bert.eval()
    config = GPT2Config.from_json_file('models/117M/config.json')
    model_gpt = load_model(GPT2LMHeadModel(config), '/home/aniljegga1/Transformers/INSET/auto_log/GPT2.2e-05.64.1gpu.2021-02-08131841//GPT2-pretrain-5-step-4500.pkl', args).cuda()
    model_pre = load_model(GPT2LMHeadModel(config), '/home/aniljegga1/Transformers/INSET/auto_log/GPT2.2e-05.64.1gpu.2021-02-08131841//PRE-pretrain-5-step-4500.pkl', args).cuda()
    model_pre.eval()
    model_gpt.eval()
    ...
    # no lexical hints
    bert_sent_no_key = BertModelSent.from_pretrained('biobert-base', state_dict=torch.load('/home/aniljegga1/Transformers/INSET/fillgap_log/GPT2.0.001.1024.1gpu.2021-02-12174656/BERTsent-10-step-17.pkl')).cuda()
    bert_sent_no_key.eval()

    with open('pubmed_input.txt') as input_file:
